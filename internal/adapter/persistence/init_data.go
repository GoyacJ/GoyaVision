...
func initMenus(ctx context.Context, repo *repository) error {
	menus := []struct {
		...
		{uuid.MustParse("00000000-0000-0000-0000-000000000020"), nil, "operator", "算子管理", 2, "/operators", "Cpu", "operator/index", "operator:list", 2, true},
		{uuid.MustParse("00000000-0000-0000-0000-000000000030"), nil, "workflow", "工作流", 2, "/workflows", "Connection", "workflow/index", "workflow:list", 3, true},
		{uuid.MustParse("00000000-0000-0000-0000-000000000040"), nil, "task", "任务管理", 2, "/tasks", "List", "task/index", "task:list", 4, true},
		{uuid.MustParse("00000000-0000-0000-0000-000000000050"), nil, "legacy", "旧功能", 1, "/legacy", "FolderOpened", "", "", 90, true},
		{uuid.MustParse("00000000-0000-0000-0000-000000000051"), ptrUUID("00000000-0000-0000-0000-000000000050"), "legacy:stream", "视频流（旧）", 2, "/streams", "Monitor", "stream/index", "stream:list", 1, true},
