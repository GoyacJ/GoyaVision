...
type Handlers struct {
	...
	CreateAlgorithm             *command.CreateAlgorithmHandler
	UpdateAlgorithm             *command.UpdateAlgorithmHandler
	DeleteAlgorithm             *command.DeleteAlgorithmHandler
	CreateAlgorithmVersion      *command.CreateAlgorithmVersionHandler
	PublishAlgorithmVersion     *command.PublishAlgorithmVersionHandler
	...
	CreateWorkflowRevision      *command.CreateWorkflowRevisionHandler
	...
	CreateTaskContextSnapshot   *command.CreateTaskContextSnapshotHandler
	CreateAgentSession          *command.CreateAgentSessionHandler
	RunAgentSessionStep         *command.RunAgentSessionStepHandler
	StopAgentSession            *command.StopAgentSessionHandler
	...
	GetAlgorithm                *query.GetAlgorithmHandler
	ListAlgorithms              *query.ListAlgorithmsHandler
	...
	GetWorkflowRevision         *query.GetWorkflowRevisionHandler
	ListWorkflowRevisions       *query.ListWorkflowRevisionsHandler
	...
	GetTaskContext              *query.GetTaskContextHandler
	ListTaskContextPatches      *query.ListTaskContextPatchesHandler
	ListTaskEvents              *query.ListTaskEventsHandler
	GetAgentSession             *query.GetAgentSessionHandler
	ListAgentSessions           *query.ListAgentSessionsHandler
	ListAgentSessionEvents      *query.ListAgentSessionEventsHandler
...
func NewHandlers(
	...
	routingExecutor := engine.NewRoutingOperatorExecutor(executorRegistry)
	workflowEngine := infraengine.NewDAGWorkflowEngine(uow, routingExecutor, schemaValidator)
	agentRunLoop := agentruntime.NewRunLoop(uow, workflowEngine)
	...
	return &Handlers{
		...
		CreateAlgorithm:             command.NewCreateAlgorithmHandler(uow),
		UpdateAlgorithm:             command.NewUpdateAlgorithmHandler(uow),
		DeleteAlgorithm:             command.NewDeleteAlgorithmHandler(uow),
		CreateAlgorithmVersion:      command.NewCreateAlgorithmVersionHandler(uow),
		PublishAlgorithmVersion:     command.NewPublishAlgorithmVersionHandler(uow),
		...
		CreateWorkflowRevision:      command.NewCreateWorkflowRevisionHandler(uow),
		...
		CreateTaskContextSnapshot:   command.NewCreateTaskContextSnapshotHandler(uow),
		CreateAgentSession:          command.NewCreateAgentSessionHandler(uow),
		RunAgentSessionStep:         command.NewRunAgentSessionStepHandler(agentRunLoop),
		StopAgentSession:            command.NewStopAgentSessionHandler(uow),
		...
		GetAlgorithm:                query.NewGetAlgorithmHandler(uow),
		ListAlgorithms:              query.NewListAlgorithmsHandler(uow),
		...
		GetWorkflowRevision:         query.NewGetWorkflowRevisionHandler(uow),
		ListWorkflowRevisions:       query.NewListWorkflowRevisionsHandler(uow),
		...
		GetTaskContext:              query.NewGetTaskContextHandler(uow),
		ListTaskContextPatches:      query.NewListTaskContextPatchesHandler(uow),
		ListTaskEvents:              query.NewListTaskEventsHandler(uow),
		GetAgentSession:             query.NewGetAgentSessionHandler(uow),
		ListAgentSessions:           query.NewListAgentSessionsHandler(uow),
		ListAgentSessionEvents:      query.NewListAgentSessionEventsHandler(uow),
