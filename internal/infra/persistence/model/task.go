...
type TaskModel struct {
	...
	WorkflowRevisionID *uuid.UUID     `gorm:"type:uuid;index:idx_tasks_workflow_revision_id"`
	WorkflowRevision   int64          `gorm:"not null;default:0"`
	...
	ContextVersion     int64          `gorm:"not null;default:0"`
	...
	WorkflowRevisionRef *WorkflowRevisionModel `gorm:"foreignKey:WorkflowRevisionID"`
